...
class EquipoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $equipos = $em->getRepository('PruebaAppBundle:Equipo')->findAll();

        return $this->render('PruebaAppBundle:Equipo:index.html.twig', array(
            'equipos' => $equipos,
        ));
    }
    ...
    {
        $equipo = new Equipo();
        $form = $this->createForm('Prueba\AppBundle\Form\EquipoType', $equipo);
        ...
        return $this->render('PruebaAppBundle:Equipo:new.html.twig', array(
            'equipo' => $equipo,
    ...
    public function showAction(Equipo $equipo)
    {
        ...
        return $this->render('PruebaAppBundle:Equipo:show.html.twig', array(
            'equipo' => $equipo,
    ...
    {
        $deleteForm = $this->createDeleteForm($equipo);
        $editForm = $this->createForm('Prueba\AppBundle\Form\EquipoType', $equipo);
        ...
        return $this->render('PruebaAppBundle:Equipo:edit.html.twig', array(
            'equipo' => $equipo,
